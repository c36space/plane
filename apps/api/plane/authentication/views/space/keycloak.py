...
class KeycloakOauthInitiateSpaceEndpoint(View):
    """Initiate Keycloak OAuth flow for space (space.c36space.com)"""
...
class KeycloakCallbackSpaceEndpoint(View):
    """Handle Keycloak OAuth callback for space (space.c36space.com)"""
    ...
    def get(self, request):
        ...
        try:
            ...
            # Login the user and record device info for space
